...
export function InvitationsClientPage() {
  ...
  async function loadInvitation(eventId: string) {
    try {
      const data =
        await supabaseInvitationService.getInvitationByEventId(eventId);
      if (data) {
            ...
            <Card className="rounded-[2rem] shadow-[0_2px_40px_-12px_rgba(0,0,0,0.08)] border-gray-100/50 bg-white overflow-hidden">
              ...
              <CardContent className="p-8 space-y-4">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4 pt-4">
                      ...
                      <div className="space-y-4 pt-4">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <Input
                            value={
                              (invitation.metadata as any)?.dress_code || ""
                            }
                            disabled={!canEdit}
                            onChange={(e) =>
                      ...
                      {(invitation.metadata as any)?.rsvp?.is_active !==
                        ...
                        <div className="space-y-6 animate-in slide-in-from-top-2 p-4">
                            ...
                            <div className="flex items-center justify-between pb-1.5">
                              ...
                              <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                  type="checkbox"
                                  checked={
                                    (invitation.metadata as any)?.guest_book
                                      ?.is_active !== false
                                  }
                                  disabled={!canEdit}
                                  onChange={(e) =>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-in fade-in slide-in-from-top-1">
                                ...
                                <div className="space-y-1.5">
                                  ...
                                  <Input
                                    ...
                                    placeholder="Unggah momen manismu di acara ini"
                                    className="bg-white"
                                  />
                                </div>
                              </div>
                          ...
                          <div className="space-y-4">
                            <div className="flex items-center justify-between pb-1.5">
                              ...
                              <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                  ...
                                  checked={
                                    (invitation.metadata as any)
                                      ?.redeem_souvenir?.is_active !== false
                                  }
                                  disabled={!canEdit}
                                  onChange={(e) =>
                                    updateNestedMetadata(
                            ...
                            {(invitation.metadata as any)?.redeem_souvenir
                              ?.is_active !== false && (
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-in fade-in slide-in-from-top-1">
                                <div className="space-y-1.5">
                                  <label className="text-xs text-gray-400 mb-1 block">
                                  ...
                                  <Input
                                    ...
                                    placeholder="Pengambilan Souvenir"
                                    className="bg-white"
                                  />
                                </div>
                                <div className="space-y-1.5">
                                  ...
                                  <Input
                                    ...
                                    placeholder="Scan QR code ini di meja souvenir"
                                    className="bg-white"
                                  />
                                </div>
                              </div>
                          ...
                          {/* Section 7: Seating Information */}
                          <div className="space-y-4">
                            <div className="flex items-center justify-between pb-1.5">
                              <h5 className="text-sm font-bold text-gray-900 flex items-center gap-2">
                                <Users className="w-4 h-4 text-emerald-500" />
                                7. Seating Information
                              </h5>
                              <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                  type="checkbox"
                            ...
                            <div className="bg-amber-50 border border-amber-100 rounded-xl p-3 flex items-start gap-3">
                              ...
                              <p className="text-[11px] text-amber-800 leading-relaxed font-medium">
                                ...
                                have already assigned guests to tables in{" "}
                                <Link
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  <div className="space-y-1.5">
                                    ...
                                    <Input
                                      ...
                                      placeholder="Informasi Tempat Duduk"
                                      className="bg-white"
                                    />
                                  </div>
                                  <div className="space-y-1.5">
                                    ...
                                    <Input
                                      ...
                                      placeholder="Silakan menempati meja yang telah disediakan"
                                      className="bg-white"
                                    />
                                  </div>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  ...
                                  <div className="space-y-1.5">
                                    ...
                                    <Input
                                      value={
                                        (invitation.metadata as any)
                                          ?.seating_info?.table_shape_label ||
                                        ""
                                      }
                                      disabled={!canEdit}
                                      onChange={(e) =>
                  ...
                  <div className="bg-blue-50/50 rounded-2xl p-6 border border-blue-100 flex items-start gap-4 animate-in fade-in slide-in-from-top-4 duration-500 mt-6">
                    ...
                    <div>
                      ...
                      <p className="text-blue-700/70 text-sm leading-relaxed mt-1">
                        ...
                        in your content. These will be automatically replaced
                        with the actual details when sending the invitation.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="flex flex-col min-h-full">
                      ...
                      {(invitation.metadata as any)?.rsvp?.is_active !==
                        ...
                        (invitation.metadata as any)?.qr_invitation
                          ...
                          <>
                            <div className="w-full h-px bg-gray-100" />
                            <div className="px-6 py-10 space-y-8 bg-[#FCFDFD] animate-in fade-in slide-in-from-bottom-2">
                              {/* QR Card - Same as RSVPForm.tsx confirmed state */}
                              <div className="bg-white p-8 rounded-[2rem] border border-gray-100 flex flex-col items-center space-y-4 mb-4 w-full">
                                <div className="text-center space-y-1">
                                  <p className="text-[10px] text-gray-400 uppercase tracking-[0.2em] font-bold">
                                    QR Masuk
                                  </p>
                                  <h3 className="font-bold text-xl text-gray-900 italic font-serif">
                                    Guest Name
                                  </h3>
                                ...
                                <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm transition-transform duration-500 hover:scale-105">
                                  <QrCode className="w-20 h-20 text-gray-900" />
                                </div>

                                <p className="text-[8px] text-center text-gray-400 max-w-[200px] mx-auto leading-relaxed font-medium uppercase tracking-wider">
                                  Silakan tunjukkan kode QR ini di meja penerima
                                  tamu untuk check-in.
                                </p>
                              </div>

                              <div className="w-full">
                                <Button className="w-full h-12 rounded-xl bg-[#3EA0FE] hover:bg-blue-600 shadow-lg shadow-blue-500/20 text-white font-bold transition-all hover:scale-[1.02]">
                                  Unduh QR Check-In
                                </Button>
                              </div>
                            </div>
                      ...
                      {(invitation.metadata as any)?.rsvp?.is_active !==
                        false &&
                        (invitation.metadata as any)?.guest_book?.is_active !==
                          false && (
                          <>
                            <div className="w-full h-px bg-gray-100" />
                            <div className="px-6 py-6 space-y-6 bg-white animate-in fade-in slide-in-from-bottom-2">
                              <div className="text-center space-y-2">
                                <h4 className="text-xl font-bold text-gray-900 tracking-tight italic font-serif">
                                  {(invitation.metadata as any)?.guest_book
                                    ?.title || "Guest Book Photo"}
                                </h4>
                                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">
                                  {(invitation.metadata as any)?.guest_book
                                    ?.subtitle ||
                              ...
                              <div className="border-2 border-dashed border-gray-200 rounded-xl p-8 flex flex-col items-center gap-2 text-gray-400 bg-gray-50/50">
                          ...
                          <>
                            ...
                            <div className="px-6 py-10 space-y-8 bg-[#FCFDFD] animate-in fade-in slide-in-from-bottom-2">
                              ...
                              <div className="relative w-full max-w-[280px] mx-auto">
                                ...
                                <div className="relative bg-white rounded-3xl border border-blue-100/50">
                                  {/* Top Section: QR Code */}
                                  <div className="relative bg-gradient-to-br from-blue-50 to-cyan-50/50 p-4 text-center rounded-t-[1.4rem]">
                                    {/* Left and Right "Notches" for Ticket Effect */}
                                    <div className="absolute -left-[1px] top-full -translate-y-1/2 w-3 h-6 bg-[#FCFDFD] rounded-r-full border-t border-r border-b border-blue-100/50 z-10" />
                                    <div className="absolute -right-[1px] top-full -translate-y-1/2 w-3 h-6 bg-[#FCFDFD] rounded-l-full border-t border-l border-b border-blue-100/50 z-10" />
                                  ...
                                  <div className="bg-white p-6 relative rounded-b-[1.4rem]">
                                    <div className="space-y-4 text-center">
                                      <div className="space-y-1">
                                        <h3 className="text-[8px] font-bold text-gray-400 uppercase tracking-[0.2em]">
                                          Souvenir Voucher
                                        </h3>
                                        <p className="text-sm font-serif italic text-gray-900 font-bold">
                                          Valid for One Guest
                                        </p>
                                      </div>

                                      <div className="bg-purple-50 rounded-xl p-2 flex items-center justify-center gap-2 text-purple-700 border border-purple-100">
                                      ...
                                      <p className="text-[8px] text-gray-400 leading-tight">
                                        Show this voucher to our staff at the
                                        souvenir counter.
                                      </p>
                                    </div>
                                  </div>
                      ...
                      {(invitation.metadata as any)?.rsvp?.is_active !==
                        ...
                        (invitation.metadata as any)?.seating_info
                          ...
                          <>
                            <div className="w-full h-px bg-gray-100" />
                            <div className="px-6 py-8 space-y-6 bg-white animate-in fade-in slide-in-from-bottom-2">
                              <div className="text-center space-y-2">
                                <h4 className="text-xl font-bold text-gray-900 tracking-tight italic font-serif">
                                  {(invitation.metadata as any)?.seating_info
                                    ?.title || "Seating Info"}
                                ...
                                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">
                                  {(invitation.metadata as any)?.seating_info
                                    ?.subtitle || "Your assigned seat"}
                                </p>
                              </div>
                              <div className="grid grid-cols-2 gap-4">
                                <div className="bg-emerald-50/50 p-4 rounded-2xl border border-emerald-100/50 text-center space-y-1">
                                  <p className="text-[8px] text-emerald-600 font-bold uppercase tracking-widest">
                                    {(invitation.metadata as any)?.seating_info
                                      ?.table_name_label || "Table"}
                                  </p>
                                  <p className="text-sm font-serif font-black text-emerald-900 italic">
                                    VIP Table 01
                                  </p>
                                </div>
                                <div className="bg-emerald-50/50 p-4 rounded-2xl border border-emerald-100/50 text-center space-y-1">
                      ...
                      {(invitation.metadata as any)?.rsvp?.is_active !==
                        ...
                        (invitation.metadata as any)?.wishes_section
                          ...
                          <>
                            <div className="w-full h-px bg-gray-100" />
                            <div className="px-6 py-10 space-y-6 bg-[#FCFDFD] animate-in fade-in slide-in-from-bottom-2">
                              ...
                              <div className="flex gap-3 overflow-hidden opacity-50">
                                <div className="bg-white border border-gray-100 p-4 rounded-xl min-w-[200px] text-xs shadow-sm">
                                ...
                                <div className="bg-white border border-gray-100 p-4 rounded-xl min-w-[200px] text-xs shadow-sm">
                                  ...
                                  <p className="text-gray-500 italic">
                                    "May your journey together be filled with
                                    joy and wonderful adventures. Best wishes!"
                                  </p>
                                </div>
                              </div>
                            </div>
