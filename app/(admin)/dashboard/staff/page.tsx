...
export default function StaffPage() {
  ...
  return (
    <PermissionGuard resource="staff" action="view" redirectTo="/restricted">
      <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <Tabs defaultValue="staff" className="space-y-4">
          <TabsList className="grid w-sm max-w-md grid-cols-2 bg-white border border-gray-100 p-1.5 rounded-xl h-auto">
            ...
            {(() => {
              const canManageRoles = hasPermission("staff", "manage_roles");
              return (
                <TabsTrigger
                  value="roles"
          ...
          <TabsContent value="staff" className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <PermissionGuard resource="staff" action="add">
                <AddStaffDialog
                  ...
                  >
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="pt-4 flex items-center justify-between border-t border-gray-50">
                        ...
                        <PermissionGuard resource="staff" action="remove">
                          <Button
                            variant="ghost"
                            size="icon"
          ...
          <TabsContent value="roles">
            <PermissionGuard resource="staff" action="manage_roles">
          ...
          <DialogContent className="max-w-md rounded-[2rem] border-none shadow-2xl p-6 text-left">
            ...
            <div className="py-4 space-y-4">
              <p className="text-gray-500">
                Are you sure you want to remove this staff member? They will
                lose access to this event.
              </p>
            </div>
